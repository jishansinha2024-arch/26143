...
export default function Verify() {
  ...
  return (
    <div className="min-h-screen px-6 py-12" style={{ background: "var(--bg-primary, #ffffff)", color: "#0a2540" }} data-testid="verify-page">
