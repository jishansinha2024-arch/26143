...
export const TYPE_COLOR = { territorial: "#c2410c", contiguous: "#b26a00", eez: "#1479c4", port_state: "#006a61", custom: "#6f4fa8" };
...
export const PROV_COLOR = { AUTHORITATIVE: "#006a61", REFERENCE: "#1479c4", DEMO: "#b26a00", "USER-DEFINED": "#6f4fa8", PRESET: "#0a2540", UNVERIFIED: "#5b86b3" };

export const zoneStyle = (ft, selected) => ({ color: TYPE_COLOR[ft.properties.zone_type] || "#5b86b3", weight: selected === ft.properties.code ? 3 : ft.properties.zone_type === "territorial" ? 2 : 1.5, fillOpacity: selected === ft.properties.code ? 0.28 : 0.13, dashArray: TYPE_DASH[ft.properties.zone_type] ?? null });
