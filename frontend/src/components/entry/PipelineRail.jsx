...
import { PIPELINE } from "./entryData";

export function PipelineRail() {
  return (
    <ol className="relative mt-12 max-w-lg border-l border-ink/10 pl-6" data-testid="what-it-does">
      {PIPELINE.map((stage, index) => (
        ...
        >
          ...
          <p className="mt-1 text-sm leading-relaxed text-fog">{stage.detail}</p>
        </motion.li>
      ))}
    </ol>
  );
